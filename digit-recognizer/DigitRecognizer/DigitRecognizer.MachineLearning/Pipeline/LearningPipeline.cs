    ...
    public class LearningPipeline : ICollection<ILearningPipelineItem>
    {
        ...
        public PredictionModel Run()
        {
            ...
            for (var epoch = 0; epoch < PipelineSettings.EpochCount; epoch++)
            {
                ...
                ConsoleUtility.WriteLine($"TrainingIterations Count: {PipelineSettings.TrainingIterationsCount} ");

                for (var TrainingIterationsIndex = 0; TrainingIterationsIndex < PipelineSettings.TrainingIterationsCount; TrainingIterationsIndex++)
                {
